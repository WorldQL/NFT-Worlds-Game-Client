...
export const WorldCard: FC<Props> = ({ world }) => (
  <div className='bg-gradient-to-b from-bg-top to-bg-bottom rounded-lg shadow-xl flex flex-col w-[var(--card-width)]'>
    <img
      className='h-[200px] object-cover rounded-t-lg'
      src={world.branding.banner}
    />

    <div className='rounded-b-lg p-3 pt-0 pb-4 text-center'>
      <div
